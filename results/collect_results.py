...
INPUT: Name of the test bin inside u1008557/tests/
"""
...
class Navigation:
    ...
    def plot_from_pickle(self, beamBendingPkl):
        """
        Generates a plot of the trial results named "best_individual.png" within the trial bin.
        Copies the plot into the plots bin inside the testing parent directory
...
def main():
    ...
    testDir = sys.argv[-1]  # The test dir is assumed to be in u1008557/tests/
