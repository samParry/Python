"""
Created Wed Sep  9 23:35:05 2020
@author: Sam Parry
"""
...
# file paths
chpc_parent_dir = "/uufs/chpc.utah.edu/common/home/u1008557/tuning_params"
...
# creates a new set of parameters for each possible combination
        ...
        for c in range(len(differential_weight)):
            for d in range(len(crossover_rate)):
                for e in range(len(mutation_rate)):
                    ...
                    # function call
                    createDirectories(params, chpc_parent_dir, folder, 10)
